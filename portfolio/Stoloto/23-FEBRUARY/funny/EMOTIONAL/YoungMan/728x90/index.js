...
const words = [
    ['В\u00A0кармане билет "Русское\u00A0лото" -', "шанс выиграть новое авто!"],
    ["Победите утренний сон и\u00A0станьте", "обладателем нового авто!"],
    ["Хватит ездить на\u00A0метро,", 'купите билет "Русскоe\u00A0лото!"'],
];
rotation();
function rotation() {
