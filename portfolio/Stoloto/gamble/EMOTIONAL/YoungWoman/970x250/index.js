...
const words = [
    ["Хватит откладывать на\u00A0потом,", "СЕЙЧАС САМОЕ ВРЕМЯ!"],
    ["Потратьте время с\u00A0пользой -", 'играйте в\u00A0"Русское\u00A0лото"!'],
    ["Выиграйте для\u00A0него", "автомобиль!"],
];
rotation();
function rotation() {
