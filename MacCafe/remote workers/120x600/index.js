...
function changeTexts() {
    if (hour >= 0 && hour < 12) {
        ...
        secondStroke.textContent = "пройдитесь";
        ...
        secondStroke.textContent = "стоит выйти";
        thirdStroke.textContent = "на обед";
        clickout = "extra1";
        screenad.event("IMPRESSION_2");
        clickEvent = "CLICK_2";
    } else if (hour >= 15 && hour < 18) {
        firstStroke.style.fontSize = "14.5px";
        secondStroke.style.fontSize = "14.5px";
        thirdStroke.style.fontSize = "14.5px";
