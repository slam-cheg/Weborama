...
function changeTexts() {
    if (hour >= 0 && hour < 12) {
        ...
        firstStroke.style.fontSize = "46px";
        secondStroke.style.fontSize = "46px";
        thirdStroke.style.fontSize = "46px";
        firstStroke.textContent = "Бафнись";
        secondStroke.textContent = "бодрящим МакКафе";
        clickout = "extra1";
        screenad.event("IMPRESSION_2");
        clickEvent = "CLICK_2";
    } else if (hour >= 15 && hour < 18) {
        firstStroke.textContent = "Побудь afk";
        secondStroke.textContent = "вместе с МакКафе";
        clickout = "extra2";
